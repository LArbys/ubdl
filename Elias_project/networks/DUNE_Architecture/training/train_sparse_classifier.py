...
INPUTFILE_TRAIN="/media/data/larbys/ebengh01/SparseClassifierTrainingSet_5.root" # output_10001.root SparseClassifierTrainingSet_5.root
...
def main():
    ...
    NENTRIES = 197658 # Taken from rootfile 197658 37
...
def train(train_file, model, device, criterion, optimizer, batchsize, nbatches, iiter, print_freq):
    ...
    for i in range(0,nbatches):
        ...
        for j in range(0,batchsize):
            ...
            predict_t = model(coord_t, input_t, batchsize, rse)
