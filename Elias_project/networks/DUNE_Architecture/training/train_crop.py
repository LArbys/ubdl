...
from networkmodel_less_p import SparseClassifier
from SparseClassDataset_crop import load_classifier_larcvdata
from loss_sparse_classifier import SparseClassifierLoss
import dataloader_crop as dl
...
INPUTFILE_TRAIN="/media/data/larbys/ebengh01/img2d_w_vert.root" # output_10001.root SparseClassifierTrainingSet.root
INPUTFILE_VALID="/media/data/larbys/ebengh01/img2d_w_vert.root" # output_9656.root SparseClassifierValidationSet.root
TICKBACKWARD=False
PLANE = 0
start_iter  = 0
num_iters   = 50000
