...
class InteractionClassifierDataset(torchdata.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return coord_list[0], coord_list[1], coord_list[2], val_list[0], val_list[1], val_list[2], truth_list

        # return coord_u, val_u, truth_list
        # return data_u, data_v, data_y, truth_list, rse
