...
int main(int nargs, char** argv){
  ...
  std::string output_file = output_dir + "img2d_w_vert.root";
  ...
  // loop through all the entries in the file
    ...
    larcv::EventPGraph* ev_in_test_pgraph  = (larcv::EventPGraph*)(in_larcv->get_data(larcv::kProductPGraph,"test"));
    ...
    larcv::EventImage2D* ev_out_adc_dlreco = (larcv::EventImage2D*)out_larcv->get_data(larcv::kProductImage2D,"thresh10");
    ...
    larcv::EventPGraph* ev_out_test_pgraph  = (larcv::EventPGraph*)(out_larcv->get_data(larcv::kProductPGraph,"thresh10"));
    // turn larcv object into an object
    std::vector<larcv::PGraph> test_pgraph_v = ev_in_test_pgraph->PGraphArray();
    ev_out_test_pgraph->Emplace(std::move(test_pgraph_v));
